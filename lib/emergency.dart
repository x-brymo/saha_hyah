...
//   final double cardContainerTopPadding;

  @override
  Widget build(BuildContext context) {
    final bannerHeight = MediaQuery.of(context).size.height * .25;
    final listHeight = MediaQuery.of(context).size.height * .75;
    final cardContainerHeight = 200;
    final cardContainerTopPadding = bannerHeight / 2;
    final listPaddingTop = cardContainerHeight - (bannerHeight / 2);
    return Scaffold(
      drawer: SideDraw(),
      body: Stack(
        children: <Widget>[
  ...
  Container bodyBloodRequestList(BuildContext context) {
    return Container(
      ...
      padding:
           EdgeInsets.only(top: 200 -(MediaQuery.of(context).size.height * .25 / 2), right: 10.0, left: 10.0),
      child: Column(
        children: <Widget>[
          rowRecentUpdates(),
  ...
  ListView listRecentUpdates() {
    return ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return RecentUpdateListWidget(receiverName: "receiverName", receiverAge: "receiverAge", receiverSex: "receiverSex", receiverDistance: "receiverDistance", postedAtTime: "postedAtTime");
        });
  }
  ...
  Container cardContainer(BuildContext context) {
    return Container(
      ...
      padding: new EdgeInsets.only(
          top: MediaQuery.of(context).size.height * .25 /2, right: 20.0, left: 20.0),
      child: Container(
        height: 200,
        width: MediaQuery.of(context).size.width,
        child: Container(
...
class PercentageWidget extends StatelessWidget {
  ...
  const PercentageWidget({super.key, required this.size, required this.count, required this.percentage, required this.title, required this.countLeft});
...
class RecentUpdateListWidget extends StatelessWidget {
  ...
  const RecentUpdateListWidget({super.key, required this.receiverName, required this.receiverAge, required this.receiverSex, required this.receiverDistance, required this.postedAtTime});
        ...
        child: Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child: BloodGroupThumbnailWidget(requirement: '', bloodGroup: '',),
            ),
            Column(
...
class BloodGroupThumbnailWidget extends StatelessWidget {
  ...
  const BloodGroupThumbnailWidget({super.key, required this.requirement, required this.bloodGroup});
